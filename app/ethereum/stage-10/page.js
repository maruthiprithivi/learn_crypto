...
export default function EthereumStage10() {
  const nextStage = 10 < 12 ? 10 + 1 : null
  ...
  return (
    <StageLayout
      ...
      stageNumber={10}
      stageTitle="Stage 10"
      stageDescription="Ethereum learning stage 10"
      nextStageHref={nextStage ? `/ethereum/stage-${nextStage}` : null}
      estimatedTime="15 min"
    >
      <Card className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">Stage 10 Content</h2>
      ...
      <Card className="bg-blue-500/10 border-blue-500/50">
        ...
        <ul className="space-y-3 text-gray-300">
          <li className="flex items-start gap-3">
            ...
            <span>Content for stage 10 will be added</span>
          </li>
        </ul>
      </Card>
    </StageLayout>
