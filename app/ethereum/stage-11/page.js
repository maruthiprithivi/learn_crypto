...
export default function EthereumStage11() {
  const nextStage = 11 < 12 ? 11 + 1 : null
  ...
  return (
    <StageLayout
      ...
      stageNumber={11}
      stageTitle="Stage 11"
      stageDescription="Ethereum learning stage 11"
      nextStageHref={nextStage ? `/ethereum/stage-${nextStage}` : null}
      estimatedTime="15 min"
    >
      <Card className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">Stage 11 Content</h2>
      ...
      <Card className="bg-blue-500/10 border-blue-500/50">
        ...
        <ul className="space-y-3 text-gray-300">
          <li className="flex items-start gap-3">
            ...
            <span>Content for stage 11 will be added</span>
          </li>
        </ul>
      </Card>
    </StageLayout>
