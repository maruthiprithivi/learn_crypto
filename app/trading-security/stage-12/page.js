...
export default function Stage12() {
  ...
  const nextStage = 12 < maxStage ? 12 + 1 : null
  ...
  return (
    ...
    >
      <Card className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">Stage 12</h2>
      ...
      <Card className="bg-blue-500/10 border-blue-500/50">
        ...
        <p className="text-gray-300">Content coming soon for stage 12</p>
      </Card>
    </StageLayout>
  )
}
